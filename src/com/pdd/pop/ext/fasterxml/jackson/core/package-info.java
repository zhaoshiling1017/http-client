 ...
 * processor: most importantly {@link com.pdd.pop.ext.fasterxml.jackson.core.JsonFactory}
 * used for constructing
 * JSON parser ({@link com.pdd.pop.ext.fasterxml.jackson.core.JsonParser})
 * and generator
 ...
 * <ul>
 *<li>{@link com.pdd.pop.ext.fasterxml.jackson.core.TreeNode} is included
 ...
 *  </li>
 *<li>{@link com.pdd.pop.ext.fasterxml.jackson.core.ObjectCodec} is included so that
 *  reference to the object capable of serializing/deserializing
 *  Objects to/from JSON (usually, <code>com.pdd.pop.ext.fasterxml.jackson.databind.ObjectMapper</code>)
