...
e. 点击上传时，支持批量上传详情图
    ...
    public Map<String, String> getParamsMap() {
        ...
        if(paperNetWeight != null) {
            paramsMap.put("paper_net_weight", paperNetWeight.toString());
            
        }
        if(paperLength != null) {
            paramsMap.put("paper_length", paperLength.toString());
            
        }
        if(paperWidth != null) {
            paramsMap.put("paper_width", paperWidth.toString());
            
        }
        if(paperPliesNum != null) {
            paramsMap.put("paper_plies_num", paperPliesNum.toString());
    ...
    public void setPaperNetWeight(Long paperNetWeight) {
        this.paperNetWeight = paperNetWeight;
    }
    ...
    public void setPaperPliesNum(Long paperPliesNum) {
        this.paperPliesNum = paperPliesNum;
    }
