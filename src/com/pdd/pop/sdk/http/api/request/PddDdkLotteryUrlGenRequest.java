...
public class PddDdkLotteryUrlGenRequest extends PopBaseHttpRequest<PddDdkLotteryUrlGenResponse>{
    ...
    @Override
    public Class<PddDdkLotteryUrlGenResponse> getResponseClass() {
        return PddDdkLotteryUrlGenResponse.class;
    }
