...
package com.pdd.pop.ext.apache.http.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link com.pdd.pop.ext.apache.http.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link com.pdd.pop.ext.apache.http.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link com.pdd.pop.ext.apache.http.auth.Credentials}.
     * <p>
     ...
     *  {@link com.pdd.pop.ext.apache.http.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link com.pdd.pop.ext.apache.http.auth.AuthScheme#getSchemeName()}.
     */
    public static final String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link com.pdd.pop.ext.apache.http.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
