 ...
 * {@link com.pdd.pop.ext.apache.http.conn.ClientConnectionManager connection managers} for
 * a fine-grained control of connections on a per route basis.
 *
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link com.pdd.pop.ext.apache.http.pool.ConnPoolControl}
 */
@Deprecated
