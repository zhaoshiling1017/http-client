...
import com.pdd.pop.sdk.http.api.response.PddDdkOauthThemePromUrlGenerateResponse;
...
public class PddDdkOauthThemePromUrlGenerateRequest extends PopBaseHttpRequest<PddDdkOauthThemePromUrlGenerateResponse>{
    ...
    @Override
    public Class<PddDdkOauthThemePromUrlGenerateResponse> getResponseClass() {
        return PddDdkOauthThemePromUrlGenerateResponse.class;
    }
