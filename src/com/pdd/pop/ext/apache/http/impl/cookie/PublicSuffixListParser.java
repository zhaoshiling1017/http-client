 ...
 *
 * @deprecated (4.4) use {@link com.pdd.pop.ext.apache.http.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
...
public class PublicSuffixListParser {
    ...
    private final com.pdd.pop.ext.apache.http.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new com.pdd.pop.ext.apache.http.conn.util.PublicSuffixListParser();
    }
